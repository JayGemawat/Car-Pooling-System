...
require_once('functions.php');
connectdb();
$connection = mysqli_connect('localhost:3306', 'root', '', 'carpool'); // Replace with your database credentials
...
<?php
        while($row = mysqli_fetch_array($result)){
            ...
            if($type=="1"){
                ...
                $result1 = mysqli_query($connection,$query) or die("error!!");
...
<div id="push"></div>
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Built with love by <a href="about.php">@jay</a></p>
      </div>
    </div>
