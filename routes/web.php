...
route('GET', '/notifications/count', fn() => (new NotificationController())->count());
route('GET', '/notifications/recent', fn() => (new NotificationController())->recent());
route('POST', '/notifications/delete', fn() => (new NotificationController())->delete());
