...
<div class="row g-4">
  ...
  <div class="col-12 col-lg-5">
    <div class="card p-4 mb-4">
      <h5 class="fw-bold mb-3"><i class="bi bi-person-circle me-2"></i>Profile</h5>
  ...
  <div class="col-12 col-lg-7">
    <h5 class="fw-bold mb-3"><i class="bi bi-car-front me-2"></i>My Rides</h5>
    <?php if (empty($rides)): ?>
      <div class="text-center text-muted py-5">
        <i class="bi bi-car-front fs-1"></i>
        <p class="mt-2">You haven't shared any rides yet.</p>
