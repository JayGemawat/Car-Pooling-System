...
if (isset($_POST['host'])) {
    ...
    $insertAdminQuery = "INSERT INTO `users` (`name`, `random`, `hash`, `email`, `gender`) VALUES ('admin',  randomNum(5),crypt('admin', randomNum(5)), '$email', '$gender')";
...
<html lang="en">
  ...
  <body>
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Built with love by <a href="about.php">@jay.</p>
      </div>
    </div>
